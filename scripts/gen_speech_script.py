...
script(doc, "「右边黄色卡片是新功能——积分激励体系。逻辑很简单：新用户注册送 100 分，上传被审核通过 +10 分，资源被下载 +2 分，被好评 +1 分。下载消耗 1 分，每天还有 3 次免费下载兜底。攒够 50 分能换 10 次下载，100 分可以让自己上传的资源置顶 7 天。」")
...
script(doc, "「老师如果想兑换 50 分换 10 次下载次数，点一下就行——但老师只有 99 分，够。我们演示一下兑换……」")
